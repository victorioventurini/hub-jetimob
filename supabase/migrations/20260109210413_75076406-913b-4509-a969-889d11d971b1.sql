-- ============================================
-- WAVE 5: Identity Unification v2.2 - handle_new_user
-- ============================================

-- Atualizar handle_new_user para criar membership com profile_id
...
COMMENT ON FUNCTION handle_new_user() IS 'Wave 5: Cria profile e membership com profile_id na criação de novo usuário.';