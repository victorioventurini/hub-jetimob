-- =============================================
-- Suporte a Onboarding para Partner Contacts (External Users)
-- =============================================
-- Atualiza handle_new_user para criar profiles para partner contacts
...
-- Add user_id column to partner_contacts if not exists
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Add 'external' to app_role enum if not exists
DO $$
BEGIN
  IF NOT EXISTS (
