-- P0 Critical: Corrigir views com SECURITY DEFINER para INVOKER
-- Garante que RLS seja respeitado em todas as views

-- Recriar v_ai_agents_public com SECURITY INVOKER
...
COMMENT ON VIEW public.v_ai_agents_public IS 'Public view of active AI agents. Uses SECURITY INVOKER to respect RLS.';

-- Recriar v_profiles_directory com SECURITY INVOKER
...
GRANT SELECT ON public.v_profiles_directory TO authenticated;

COMMENT ON VIEW public.v_profiles_directory IS 'Directory view of profiles for user selection. Uses SECURITY INVOKER to respect RLS.';