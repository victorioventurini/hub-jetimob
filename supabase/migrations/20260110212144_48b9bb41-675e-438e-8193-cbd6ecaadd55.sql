...
BEGIN
  ...
  -- Mark as internal call to bypass protective triggers for controlled updates
  ...
  -- Ensure BU membership exists and is linked to the new user.
  -- IMPORTANT: pre-created profiles may already have a default membership row (profile_id unique partial index).
