-- ============================================================
-- FIX: search_bu_users_for_mention precisa de SECURITY DEFINER
-- para acessar v_bu_active_profiles (que depende de tabelas com RLS)
-- ============================================================

-- Drop e recria a função com SECURITY DEFINER
