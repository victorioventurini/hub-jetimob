...
-- Fix get_global_users_admin to use profile_id instead of user_id for memberships
-- This ensures users without login (user_id = NULL) still show their BU accesses
...
COMMENT ON FUNCTION get_global_users_admin IS 'Lista todos os profiles para admin global. Usa profile_id para memberships (suporta profiles sem login).';
