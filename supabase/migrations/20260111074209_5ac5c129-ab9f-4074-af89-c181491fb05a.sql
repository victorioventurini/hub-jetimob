...
-- 1. Drop and recreate v_ai_agents_public with SECURITY INVOKER
...
COMMENT ON VIEW public.v_ai_agents_public IS 'Public view of AI agents with proper SECURITY INVOKER';

-- 2. Drop and recreate v_profiles_directory with SECURITY INVOKER
...
COMMENT ON VIEW public.v_profiles_directory IS 'Directory view of profiles with proper SECURITY INVOKER';
