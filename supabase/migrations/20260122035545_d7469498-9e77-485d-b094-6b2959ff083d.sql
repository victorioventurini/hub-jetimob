...
-- Fix can_view_ticket function to check both profile_id and partner_contact_id for participants
-- Issue: External users with profiles were not found because they were registered with partner_contact_id
