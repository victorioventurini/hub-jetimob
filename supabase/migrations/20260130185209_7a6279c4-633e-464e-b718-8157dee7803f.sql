-- Migration: Corrigir função search_mention_candidates para incluir team_name e external_company_name
...
COMMENT ON FUNCTION public.search_mention_candidates(uuid, uuid, text, integer) IS 'Busca candidatos para menção (usuários internos e contatos externos). Retorna team_name para internos e external_company_name para externos. Parâmetro renomeado de p_partner_company_id para p_external_company_id em v2.76.0';