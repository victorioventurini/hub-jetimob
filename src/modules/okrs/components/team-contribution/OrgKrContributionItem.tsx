...
const statusConfig = {
  green: { label: 'On Track', className: 'bg-green-500/10 text-green-700' },
  yellow: { label: 'Em Risco', className: 'bg-yellow-500/10 text-yellow-700' },
  red: { label: 'Off Track', className: 'bg-red-500/10 text-red-700' },
