...
export const WIZARD_AGENT_MAP: Record<OkrWizardType, Record<string, VicAgentSlug>> = {
  'creation': {
    ...
    'objective': 'validador-metodologico-okrs',
    'sharing': 'alinhamento-estrategico',
    'kr-type': 'validador-metodologico-okrs',
    'kr-detail': 'validador-metodologico-okrs',
    'dependencies': 'alinhamento-estrategico',
    'initiatives': 'validador-metodologico-okrs',
    'share': 'revisor-comunicacao',
    'default': 'validador-metodologico-okrs',
  },
  'team-checkin': {
